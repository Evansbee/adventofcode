...
def problem1(problem_input):
	...
	layer_to_investigate = [k for k,v in direct_calc.items() if v == min(direct_calc.values())][0]

	return layer_list[layer_to_investigate].count(1) * layer_list[layer_to_investigate].count(2)
