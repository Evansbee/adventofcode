...
if __name__ == "__main__":
    ...
    try:
        ...
        if result1:
            print(
                Fore.GREEN
                + f"Day {day} Problem 1 Result "
                + Fore.BLUE
                + f"(Computed in {result1_time:0.2f}s): "
                + Fore.RESET
                + f"{result1}"
            )
        else:
            print(
                Fore.RED + f"Day {day} Problem 1 Result: " + Fore.RESET + "unknown..."
            )
        t0 = time.time()
        ...
        if result2 is not None:
            ...
            print(
                Fore.RED + f"Day {day} Problem 2 Result: " + Fore.RESET + "unknown..."
            )
